...
Exonic.Class <- c("clst_Ke2011_ESE",
                  "rmv_Ke2011_ESE",
                  "clst_Ke2011_ESS",
                  "rmv_Ke2011_ESS",
                  "rnd_exon_1nt",
...
mean(abs(Plot.DF$Delta.PSI[which(Plot.DF$Starting.PSI.Group == 5)]) > 0.1)
median(abs(Plot.DF$Delta.PSI[which(Plot.DF$Starting.PSI.Group == 5)]))

mean(abs(Plot.DF$Delta.PSI[which(Plot.DF$Starting.PSI.Group == 2)]) > 0.1)
...
Violin.Plots <- ggplot(data = Plot.DF,
  ...
  annotate(geom = "text",
           ...
           y = 0,
           label = "n = 26-27")
ggsave(filename = "185_Violin_Plots_DHFR.pdf", plot = Violin.Plots, width = 8, height = 8, useDingbats = F)
...
ggsave(filename = "185_Violin_Plots_SMN1.pdf", plot = Violin.Plots, width = 8, height = 8, useDingbats = F)
...
Exonic.Mutations <- Kosuri.Subtable
Exonic.Mutations <- Exonic.Mutations[which(Exonic.Mutations$label == "exon"),]
...
ggsave(filename = "185_Violin_Plots_SNV.pdf", plot = Violin.Plots, width = 8, height = 8, useDingbats = F)
