...
ggsave(filename = "193_Violin_Plots_HepG2.pdf", plot = Violin.Plots, width = 8, height = 8, useDingbats = F)
...
ggsave(filename = "193_Violin_Plots_K562.pdf", plot = Violin.Plots, width = 8, height = 8, useDingbats = F)
